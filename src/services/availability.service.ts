 ...
 *
 * Sans cette synchro, availability_rules reste vide -> 0 créneau -> l'IA ne peut
 * jamais réserver. On régénère les règles à chaque sauvegarde des horaires.
 *
...
export async function syncAvailabilityRules(restaurantId: string): Promise<number> {
    ...
    // Cohérence : alimenter restaurant_settings (utilisé par create_booking_atomic).
    await supabase
